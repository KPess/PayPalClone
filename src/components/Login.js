...
import { setUsername, setBalance } from '../redux/reducer';
...
export default connect(mapStateToProps, {setUsername, setBalance})(Login); //connect invoked returns a function, and then passes in register
